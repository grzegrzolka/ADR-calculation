...
def classification(isotopes_in_package):    #define function to classify the package based on isotopes and their activities def=define
    ...
    sum_fi = 0
    fi_A1i = 0.0000000001 # Initialize to avoid division by zero, fraction of isotope activity in mixture to A1 [TBq]
    fi_A2i = 0.0000000001 # Initialize to avoid division by zero, fraction of isotope activity in mixture to A2 [TBq]
    fi_Ti = 0.0000000001 # Initialize to avoid division by zero, fraction of isotope activity in mixture to Transport Security Threshold [TBq]
    fi_Di = 0.0000000001 # Initialize to avoid division by zero, fraction of isotope activity in mixture to D-Value [TBq]
    fi_conc= 0.0000000001 # Initialize to avoid division by zero, fraction of isotope activity in mixture to Activity concentration for exempt material (kBq/kg)
    A1_mixture = 0
    A2_mixture = 0
    T_mixture = 0
...
#classification(isotopes_in_package)
